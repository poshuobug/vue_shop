<template>
  <div>
    ...
    <el-card>
      <el-row :gutter="20">
        <el-col :span="8">
          <el-input placeholder="请输入内容" class="input-with-select" clearable v-model="queryInfo.query" @clear="getGoodsList">
...
export default {
  ...
  methods: {
    ...
    async getGoodsList() {
      ...
      console.log(res)
      if (res.meta.status !== 200) return this.$message('获取参数列表失败！')
